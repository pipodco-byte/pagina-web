...
const mockProductos = [
  ...
  },
  {
    ...
    fields: {
      nombre: 'AirPods Pro',
      slug: 'airpods-pro',
      descripcion: 'AirPods Pro con cancelación de ruido activa',
      precio: 1299000,
      condicion: 'Nuevo',
      useCase: 'Viajeros',
      sku: 'AIRPODS-PRO-2',
  ...
  },
  {
    ...
    fields: {
      ...
      descripcion: 'Cargador MagSafe rápido para iPhone',
      precio: 599000,
      condicion: 'Nuevo',
      useCase: 'Profesionales',
      sku: 'MAGSAFE-CHARGER',
  ...
  },
  {
    ...
    fields: {
      nombre: 'USB-C Hub',
      slug: 'usb-c-hub',
      descripcion: 'Hub USB-C multifunción para MacBook',
      precio: 899000,
      condicion: 'Nuevo',
      useCase: 'Diseñadores',
      sku: 'USB-C-HUB',
  ...
  },
  {
    ...
    fields: {
      nombre: 'iPad Air',
      slug: 'ipad-air',
      descripcion: 'iPad Air con chip M1 y pantalla Liquid Retina',
      precio: 3999000,
      condicion: 'Seminuevo',
      useCase: 'Diseñadores',
      sku: 'IPAD-AIR-M1',
