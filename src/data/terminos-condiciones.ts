export const termsData = {
  ...
  contact: {
    support: 'soporte@pipod.com',
    warranty: 'garantia@pipod.com',
    privacy: 'privacidad@pipod.com'
  },

  widgets: [
    {
      type: 'retoma',
      title: '¿Vendes tu Apple?',
      description: 'Cotiza en 2 minutos y recibe tu oferta inmediata.',
      link: '/plan-retoma-apple',
      cta: 'Cotizar ahora'
    },
    {
      type: 'support',
      title: '¿Dudas con la garantía?',
      description: '',
      link: 'https://wa.me/573124813094',
      cta: 'Chat de Soporte'
    },
    {
      type: 'service',
